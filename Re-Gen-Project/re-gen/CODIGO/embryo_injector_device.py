...
from embryo_injection_robot import EmbryoInjectionRobot, InjectionTarget
...
class EmbryoInjectorDevice(DeviceBase):
    ...
    def __init__(self):
        ...
        self.last_target: Optional[InjectionTarget] = None
    ...
    def detect_embryo_target(self, image=None) -> Optional[InjectionTarget]:
