        ...
        for line in self.file_handle:
            ...
            if line.startswith('>'):
                ...
                if current_sequence:
                    ...
                    yield from self._process_sequence(
                        current_sequence,
                        current_header
                    )
                    current_sequence = ""
...
class ChunkProcessor:
    ...
    def add_filter(self, func: Callable[[StreamChunk], bool]) -> ChunkProcessor:
        """Adiciona filtro."""
        def wrapper(chunk: StreamChunk) -> Optional[StreamChunk]:
    ...
    def process(self, chunk: StreamChunk) -> Optional[StreamChunk]:
...
class StreamingAnalyzer:
    ...
    def get_report(self) -> dict:
        ...
        base_percent = {
            ...
            for base, count in self.base_composition.items()
        }
