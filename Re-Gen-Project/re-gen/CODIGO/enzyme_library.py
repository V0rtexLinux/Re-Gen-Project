...
class RestrictionSite:
    ...
    sticky_overhang: Optional[Tuple[int, int]] = None  # (upstream, downstream) se sticky
...
class Enzyme:
    ...
    recognition_site: Optional[RestrictionSite] = None
    
    # Para ligases e polymerases
    processivity_bp: Optional[int] = None  # Quantos bp consegue processar por ligação
    error_rate: Optional[float] = None      # Taxa de erro (0.0-1.0)
...
class EnzymeLibrary:
    ...
    def get_enzyme(self, name: str) -> Optional[Enzyme]:
