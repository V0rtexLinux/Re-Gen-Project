...
class Dinossauro:
    ...
    periodo: Period
    peso_estimado_kg: Optional[float]  # None = desconhecido
    comprimento_estimado_m: Optional[float]
    altura_estimada_m: Optional[float]
...
class SistemaReferencia:
    ...
    def buscar_por_nome(self, nome: str) -> Optional[Dinossauro]:
...
def criar_sistema_referencia_padrao() -> SistemaReferencia:
    ...
    archaeopteryx = Dinossauro(
        ...
        descendentes_vivos=[
            "Aves modernas (toda a classe Aves)"
        ],
    )
    ...
    triceratops = Dinossauro(
        ...
        genes_conservados=[
            "HOX", "BMP",  # desenvolvimento de crânio
