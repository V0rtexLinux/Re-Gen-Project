...
class Reference:
    ...
    accession: Optional[str] = None       # GenBank, UniProt, etc
...
class UniProtSearcher:
    ...
    def search(self, query: str, max_results: int = 10) -> Iterator[Reference]:
        ...
        try:
            ...
            print(f"Erro ao buscar UniProt: {e}")
...
class CrossRefSearcher:
    ...
    def search(self, query: str, max_results: int = 10) -> Iterator[Reference]:
        ...
        try:
            ...
            print(f"Erro ao buscar CrossRef: {e}")
...
class ReferenceSearcher:
    ...
    def __init__(self, ncbi_email: str, ncbi_api_key: Optional[str] = None):
    ...
    def search_all(
        ...
        # NCBI Gene
        if "ncbi" in sources:
            print(f"🔍 Buscando genes NCBI para '{query}'...")
        ...
        if "uniprot" in sources:
            print(f"🧬 Buscando UniProt para '{query}'...")
        ...
        if "crossref" in sources:
            print(f"📖 Buscando CrossRef para '{query}'...")
...
def create_searcher(ncbi_email: str, ncbi_api_key: Optional[str] = None) -> ReferenceSearcher:
