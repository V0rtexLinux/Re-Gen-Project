...
class ConfiguracaoSelecao:
    ...
    preferencia_tipo_dieta: Optional[str] = None  # "carnívoro", "herbívoro"
    preferencia_tamanho_min_kg: Optional[float] = None  # Tamanho mínimo preferido
    preferencia_tamanho_max_kg: Optional[float] = None  # Tamanho máximo preferido
    preferencia_periodo: Optional[str] = None  # "Triássico", "Jurássico", "Cretáceo"
    preferencia_grupo: Optional[DinosauroGrupo] = None
...
class SeletorDinossauro:
    ...
    def __init__(self, sistema_ref: Optional[SistemaReferencia] = None):
