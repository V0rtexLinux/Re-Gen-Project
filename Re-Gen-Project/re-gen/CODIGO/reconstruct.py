...
from ncbi_reference import ReferenceSequenceDeep
...
def reconstruct_ancestral_sequence(
    ...
    reference_panel: list[ReferenceSequence],
    ...
    for ref in reference_panel:
        aligned_ref_backbone, aligned_query = _align_to_reference(
            scanned_fragment, ref.sequence, aligner
        )
