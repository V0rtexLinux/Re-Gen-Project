...
from re_gen.hardware.dna_synthesizer_hardware import (
    DNASynthesizer,
    DNTPoolConfig,
    SynthesisParameter,
)
...
class DNASynthesizerDevice(DeviceBase):
    ...
    def __init__(self):
        ...
        self.config: DNTPoolConfig | None = None
    ...
    def synthesize(self, sequence: str, params: SynthesisParameter) -> float | None:
