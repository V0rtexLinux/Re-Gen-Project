...
class MapeadorDescendentes:
    ...
    _indice_caracteristicas: dict[CaracteristicaAncestral, list[str]] = field(default_factory=dict)
    ...
    def encontrar_melhor_referencia(
        self,
        nome_dinossauro: str,
        caracteristica_necessaria: CaracteristicaAncestral | None = None,
    ) -> EspecieDescendente | None:
        """
        ...
        if caracteristica_necessaria is not None:
            candidatos = [e for e in candidatos if caracteristica_necessaria in e.caracteristicas_preservadas]
