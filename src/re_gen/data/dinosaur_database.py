...
def _generate_additional_dinosaurs():
    ...
    obscure_dinosaurs = [
        ...
        (
            ...
            "Abelissauro",
            DinosaurPeriod.CRETACEO,
            DinosaurFamily.THEROPODA,
            DinosaurDiet.CARNIVOR,
            8.5,
            2.5,
            2300,
            "América do Sul",
        ...
        (
            "Annakotrigodon maasae",
            "Annakotrygodonte",
            DinosaurPeriod.CRETACEO,
            DinosaurFamily.CERATOPSIA,
            DinosaurDiet.HERBIVOR,
            1.8,
            0.6,
            12,
        ...
        (
            "Aragonosaurus ischigualastensis",
            "Aragonossauro",
            DinosaurPeriod.CRETACEO,
            DinosaurFamily.SAUROPODA,
            DinosaurDiet.HERBIVOR,
        ...
        (
            "Astralodon johnstoni",
            "Astralodon",
            DinosaurPeriod.CRETACEO,
            DinosaurFamily.ORNITHOPODA,
            DinosaurDiet.HERBIVOR,
            6.0,
            2.0,
            1500,
    ...
    # TODO: Replace procedural generation with curated data from PBDB/NHM
    # These 470 entries are procedurally generated from ~60 real species as placeholders.
    # Gera dinossauros com variações automáticas
    len(obscure_dinosaurs)
...
def get_dinosaur_by_name(name: str) -> DinosaurSpecies | None:
